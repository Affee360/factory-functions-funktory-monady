...
<p style="text-align: center">W wielu językach programowania map jest nazwą funkcji wyższego rzędu, która stosuje daną funkcję do każdego elementu funktora</p>
...
<p style="text-align: center">Jest tym samym co map, z dodatkową możliwością spłaszczania</p>
